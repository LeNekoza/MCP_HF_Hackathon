...
def example_basic_consultation():
    ...
    try:
        ...
        print(
            "Patient Query: I have been experiencing persistent headaches for the past week. Should I be concerned?"
        )
...
def example_medical_summary():
    ...
    try:
        ...
        summary = model.create_medical_summary(
            patient_data, include_recommendations=True
        )
...
def example_emergency_triage():
    ...
    try:
        ...
        for scenario in emergency_scenarios:
            ...
            response = nebius.medical_consultation(
                patient_query=prompt, specialty=scenario["specialty"]
            )
...
def setup_instructions():
    ...
    print("   NEBIUS_API_KEY=your-actual-api-key-here")
    print()
